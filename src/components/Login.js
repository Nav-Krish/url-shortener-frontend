...
function Login() {
  ...
  const loginUser = (user) => {
    fetch("https://url-shortener-jgbq.onrender.com/user/login", {
      method: "POST",
  ...
  return (
    <form
      className="container mt-5 w-50 login-div gap-2"
    ...
    >
      ...
      <Link to="/forgot-password" className="mt-4 cursor-pointer">
        Forgot Password ?
      </Link>
      {loading ? (
